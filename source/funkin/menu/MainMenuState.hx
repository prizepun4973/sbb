...
class MainMenuState extends BuiltinJITState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "NeoPsych v0.0.0", 12);
					...
					else
					{
						FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
						{
							...
							switch (daChoice)
							{
								...
								case 'options':
									LoadingState.loadAndSwitchState(new funkin.options.OptionsState(new MainMenuState()));
							}
						});
					}
				});
